...
from destopPetInteraction.utils.ops import get_symbol_dict, get_language_model
...
class ModelLanguage:
    ...
    def load_model(self):
        ...
        加载N-Gram语言模型到内存
        '''
        self.dict_pinyin = get_symbol_dict('destopPetInteraction/dict.txt')
        print("dick loaded ok")
...
if __name__=='__main__':
    ml = ModelLanguage('destopPetInteraction/model_language')
    ml.load_model()
